...
/// Generic Vocabulary
    ...
    public:
        ...
        /**
         * Returns the score of two std::vectors
         * @param a std::vector
         * @param b std::vector
         * @return score between std::vectors
         * @note the std::vectors must be already sorted and normalized if necessary
         */
         ...
         * later when transforming image features into std::vectors.
